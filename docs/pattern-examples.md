...
<!--
  ...
  描画確認: ./scripts/build.sh docs/pattern-examples.md output/
-->
...
<svg viewBox="0 0 500 400" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="250" y="208" text-anchor="middle" fill="#ffffff" font-size="16" font-weight="700">アウトプット</text>
  <!-- ノード -->
  <rect x="25" y="40" width="150" height="55" rx="12" fill="#fff" stroke="#F5A623" stroke-width="2" />
  <text x="100" y="75" text-anchor="middle" font-size="15" font-weight="700">LTスライド</text>
  <rect x="325" y="40" width="150" height="55" rx="12" fill="#fff" stroke="#F5A623" stroke-width="2" />
  <text x="400" y="75" text-anchor="middle" font-size="15" font-weight="700">技術ブログ</text>
  <rect x="25" y="300" width="150" height="55" rx="12" fill="#fff" stroke="#F5A623" stroke-width="2" />
  <text x="100" y="335" text-anchor="middle" font-size="15" font-weight="700">技術同人誌</text>
  <rect x="325" y="300" width="150" height="55" rx="12" fill="#fff" stroke="#F5A623" stroke-width="2" />
  <text x="400" y="335" text-anchor="middle" font-size="15" font-weight="700">OSS貢献</text>
</svg>
<div>
...
<svg viewBox="0 0 900 280" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="160" y="100" text-anchor="middle" font-size="14" font-weight="700">2022年</text>
  <text x="160" y="190" text-anchor="middle" font-size="13">活動開始</text>
  <!-- マイルストーン2 -->
  <circle cx="360" cy="140" r="18" fill="#F5A623" />
  <text x="360" y="147" text-anchor="middle" fill="#fff" font-size="13" font-weight="700">2</text>
  <text x="360" y="100" text-anchor="middle" font-size="14" font-weight="700">2023年</text>
  <text x="360" y="190" text-anchor="middle" font-size="13">毎週開催に</text>
  <!-- マイルストーン3 -->
  <circle cx="560" cy="140" r="18" fill="#F5A623" />
  <text x="560" y="147" text-anchor="middle" fill="#fff" font-size="13" font-weight="700">3</text>
  <text x="560" y="100" text-anchor="middle" font-size="14" font-weight="700">2024年</text>
  <text x="560" y="190" text-anchor="middle" font-size="13">1000人突破</text>
  <!-- マイルストーン4 -->
  <circle cx="740" cy="140" r="18" fill="#F09819" />
  <text x="740" y="147" text-anchor="middle" fill="#fff" font-size="13" font-weight="700">4</text>
  <text x="740" y="100" text-anchor="middle" font-size="14" font-weight="700">2025年</text>
  <text x="740" y="190" text-anchor="middle" font-size="13">40人/週</text>
  <!-- 補足テキスト -->
  <text x="450" y="250" text-anchor="middle" font-size="12" fill="#333333">4年間、毎週金曜日に開催</text>
</svg>
<div class="caption">図: エンジニア集会の成長タイムライン</div>
</div>

---

<!-- 画像レイアウト例5: content + アバター+吹き出し -->
<!-- 実パターン: お品書きやゴール説明でアバターを添える -->
<!-- 実スライド参照: コードを書かなくなって/5.png, 46.png -->
<!-- _class: content -->
<!-- _header: "このセッションのゴール" -->
...
<svg viewBox="0 0 320 170" xmlns="http://www.w3.org/2000/svg" style="max-height: 280px;">
  <defs>
    <clipPath id="avatar-circle-ex5">
      <circle cx="160" cy="118" r="48" />
    </clipPath>
  </defs>
  <style>
  ...
  <text x="155" y="34" text-anchor="middle" font-size="14" fill="#333333">めっちゃ悩んでいる</text>
  ...
  <image href="../assets/色調整版立ち絵画像.png" x="112" y="72" width="96" height="96" clip-path="url(#avatar-circle-ex5)" preserveAspectRatio="xMidYMin slice" />
</svg>
</div>
...
<!-- 実パターン: テキスト上部+画像下部（技術同人誌/12.png風） -->
<!-- _class: content -->
<!-- _header: "印刷所選定" -->

## 自分は株式会社グラフィックを使っています

- 安くて短納期対応、Canvaの断ち切り線にも対応
- 入稿テンプレートが充実している
...
<svg viewBox="0 0 800 120" xmlns="http://www.w3.org/2000/svg" style="max-height: 135px;">
  ...
  <circle cx="18" cy="13" r="5" fill="#ff5f56" />
  <circle cx="36" cy="13" r="5" fill="#ffbd2e" />
  <circle cx="54" cy="13" r="5" fill="#27c93f" />
  <rect x="80" y="4" width="200" height="18" rx="4" fill="#ffffff" />
  <text x="180" y="17" text-anchor="middle" font-size="9" fill="#333333">https://www.graphic.jp</text>
  <!-- コンテンツ領域 -->
  ...
  <text x="145" y="68" text-anchor="middle" font-size="14" fill="#ffffff" font-weight="700">印刷サービス一覧</text>
  <rect x="30" y="88" width="100" height="16" rx="4" fill="#F5A623" />
  <text x="80" y="100" text-anchor="middle" font-size="9" fill="#ffffff">料金表</text>
  <rect x="140" y="88" width="120" height="16" rx="4" fill="#ffffff" stroke="#F5A623" stroke-width="1" />
  <text x="200" y="100" text-anchor="middle" font-size="9" fill="#F5A623">テンプレート</text>
  <!-- 右側コンテンツ -->
  ...
  <text x="410" y="78" text-anchor="middle" font-size="12" fill="#333333">サンプル画像</text>
  <rect x="540" y="42" width="220" height="60" rx="4" fill="#f9f9f9" />
  <text x="650" y="78" text-anchor="middle" font-size="12" fill="#333333">サンプル画像</text>
</svg>
</div>
