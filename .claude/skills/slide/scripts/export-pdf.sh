...
# スライドをPDF形式で出力する
#
# Usage: ./.claude/skills/slide/scripts/export-pdf.sh <slides.md> [output-dir]
# Example: ./.claude/skills/slide/scripts/export-pdf.sh output/my-project/slide/slides.md output/
